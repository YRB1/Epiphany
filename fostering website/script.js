...
function bootstrap() {
  ...
  document.getElementById('t-next') && document.getElementById('t-next').addEventListener('click', () => showTestimonial(tIdx + 1));
  document.getElementById('t-prev') && document.getElementById('t-prev').addEventListener('click', () => showTestimonial(tIdx - 1));
  document.querySelectorAll('[id="t-next"]').forEach(b => b.addEventListener('click', () => showTestimonial(tIdx + 1)));
  document.querySelectorAll('[id="t-prev"]').forEach(b => b.addEventListener('click', () => showTestimonial(tIdx - 1)));
